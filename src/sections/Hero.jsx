          ...
          <AnimatedSection delay={0.4} y={40} className="relative z-10">
            ...
            >
              <div className="rounded-[1.8rem] overflow-hidden aspect-[4/5] md:aspect-[3/4] relative">
                <img 
                  ...
                  alt="Perfect Smile" 
                  className="w-full h-full object-cover transition-transform duration-1000 hover:scale-110 opacity-80"
                />
            ...
            >
              <div className="flex items-start gap-4">
                <div className="relative">
                  <div className="w-12 h-12 bg-accent-blue rounded-2xl flex items-center justify-center text-black font-serif text-lg font-bold">AI</div>
                  <div className="absolute -top-1 -right-1 w-3 h-3 bg-accent-blue rounded-full border-2 border-black animate-pulse shadow-[0_0_8px_#00D1FF]" />
                </div>
                <div>
                  <div className="text-[10px] uppercase tracking-widest text-[#6B7280] font-bold mb-1">Status</div>
                  <div className="text-sm font-bold text-white leading-tight">Simulator Online</div>
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-9 h-9 rounded-full border-2 border-black overflow-hidden bg-[#1A1A1A]">
                    <img src={`https://i.pravatar.cc/100?img=${i+10}`} alt="avatar" className="opacity-70" />
                  </div>
                ))}
              </div>
              <div>
                <div className="text-[10px] uppercase tracking-widest text-[#6B7280] font-bold">Trusted by</div>
                <div className="text-sm font-bold text-white">2,400+ Patients</div>
              </div>
            </motion.div>
          </AnimatedSection>
        </div>
